...
export default function Login() {
  ...
  const handleEmailAuth = async (e) => {
    ...
    try {
      const userCredential = tab === "signin" 
    ...
    >
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-input:focus { border-color: rgba(99,255,180,0.5); }
        .oauth-btn {
          width: 100%;
          display: flex;
          align-items: center;
        ...
        @media (max-width: 768px) {
          ...
          .right-panel { grid-column: span 2 !important; }
        }
      `}</style>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, position: "relative", zIndex: 1 }}>
          ...
          <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 20, color: "#fff", letterSpacing: "-0.3px" }}>
            HackHive
          </span>
        </div>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontSize: 15, color: "rgba(255,255,255,0.4)", lineHeight: 1.75, maxWidth: 300 }}>
            Connect with skilled students, showcase your projects, and turn ideas into shipped products — together.
          </p>
        </div>

        {/* Stats */}
        <div style={{ display: "flex", gap: 32, position: "relative", zIndex: 1 }}>
          {[["2.4k", "Student builders"], ["840", "Open projects"], ["120+", "Colleges"]].map(([num, label]) => (
            <div key={label}>
      ...
      >
        <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 26, fontWeight: 700, color: "#fff", letterSpacing: "-0.5px", marginBottom: 6 }}>
          ...
          <form onSubmit={handleEmailAuth}>
            <div style={{ marginBottom: 14 }}>
              <label style={{ display: "block", fontSize: 12, fontWeight: 500, color: "rgba(255,255,255,0.5)", marginBottom: 6, letterSpacing: "0.02em" }}>
                Email address
              </label>
              <input
            ...
            {/* Error */}
            {error && (
              <p style={{ fontSize: 12, color: "#ff6b6b", marginTop: 8, marginBottom: 4, lineHeight: 1.5 }}>
                {error}
              </p>
            )}
          ...
          <p style={{ textAlign: "center", fontSize: 12, color: "rgba(255,255,255,0.3)", marginTop: 20 }}>
            ...
            <span
              ...
              style={{ color: "rgba(99,255,180,0.8)", cursor: "pointer" }}
            >
